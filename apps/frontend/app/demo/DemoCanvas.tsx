...
import { renderDraws } from "@/libs/canvas/drawFunctions";
import {
  moveDraw,
  resizeDraw,
  handleShapeSelectionBox,
  calculateFarthestPoints,
} from "@/libs/canvas/updateFunctions";
import {
  getDrawAtPosition,
  hoverOverSelectionBox,
} from "@/libs/canvas/selectFunctions";
...
import {  performRedo, performUndo, pushToUndoRedoArray } from "./actionFunctions";
import {
  Tooltip,
  TooltipContent,
  TooltipProvider,
...
const Canvas = () => {
  ...
  const { socket, isLoading, isError } = useWebSocket(`${NEXT_PUBLIC_WS_URL}` );
      ...
      <div className="h-screen w-screen relative">
        ...
        <div className="fixed flex gap-2 z-2 w-fit h-fit left-3 bottom-3 bg-neutral-900 rounded-md">
          <div className="bg-neutral-900 rounded-md">
            <div className="bg-blue-300/25 p-1 flex items-center rounded-md">
              <Button
                size="icon"
          ...
          <div className="bg-neutral-900 rounded-md">
            <div className="bg-blue-300/25 p-1 flex gap-2 items-center rounded-md">
              <Tooltip>
                <TooltipTrigger asChild>
                  <Button
                    size="icon"
